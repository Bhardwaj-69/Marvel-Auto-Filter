class script(object):
    START_TXT = """<b> 🍁Jai HIND 🇮🇳 {} {},
    
<blockquote>✨ɪᴍ here for You.😉..
🏴‍☠️sᴇɴᴅ ᴍᴇ ᴀɴʏ ᴍᴏᴠɪᴇ ᴏʀ sᴇʀɪᴇs ɴᴀᴍᴇ ᴀɴᴅ sᴇᴇ ᴍʏ ᴍᴀɢɪᴄ..✨</blockquote>
<blockquote>👀ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs📧 ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ 🤞🏻</blockquote>

ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://telegram.me/BhardwajBhavit'>BhardwajBhavit🇮🇳</a>
</b>"""
    
    HELP_TXT = """<b>♨ᴄʟɪᴄᴋ ᴏɴ ᴛʜᴇ ʙᴜᴛᴛᴏɴꜱ ʙᴇʟᴏᴡ👇 ᴛᴏ ɢᴇᴛ HELP🚑..</b>"""
...
🙏🏻 ᴍʏ ᴄʀᴇᴀᴛᴏʀ : @BhardwajBhavit
🤡 ᴍʏ ᴍᴀɴᴀɢᴇʀ : <a href="https://telegram.me/LarvaLinks">💥Tap to SEE⚡</a>
🧑🏻‍💻 ʀᴇᴘᴏ : <a href="https://Google.com">ʟɪɴᴋ😁</a>
</b>"""
...
👥 😎Fᴏʀ ᴇᴠᴇʀʏ ɴᴇᴡ ᴜsᴇʀ ᴡʜᴏ sᴛᴀʀᴛs ᴛʜᴇ ʙᴏᴛ ᴜsɪɴɢ ᴛʜɪs ʟɪɴᴋ🔗, ʏᴏᴜ ᴡɪʟʟ ʀᴇᴄᴇɪᴠᴇ 💯 ᴘᴏɪɴᴛs😉. 
...
"""
    ...
    FILE_CAPTION = """<a href='https://t.me/LarvaLinks'><b>ɴᴀᴍᴇ : {file_name}</b></a>"""
...
5️⃣ ʀᴜᴘᴇᴇ ᴘᴇʀ ᴅᴀʏ 👻
3️⃣9️⃣ ʀᴜᴘᴇᴇs ғᴏʀ ᴏɴᴇ ᴍᴏɴᴛʜ 😚
7️⃣9️⃣ ʀᴜᴘᴇᴇs ғᴏʀ ᴛᴡᴏ ᴍᴏɴᴛʜs 😗
...
3:- ᴄʀᴇᴀᴛᴇ ᴀᴄᴄᴏᴜɴᴛ ᴏɴ ᴀɴʏ sʜᴏʀᴛɴᴇʀ ʟɪᴋᴇ ʏᴏᴜ ᴄᴀɴ ᴀʟsᴏ ᴜsᴇ any Best Shortner DM @BhardwajBhavit for Best Shortner.

4:- ᴛʜᴇɴ sᴇᴛ ʏᴏᴜʀ sʜᴏʀᴛɴᴇʀ ᴅᴇᴛᴀɪʟs ʙʏ ᴛʜɪs ꜰᴏʀᴍᴀᴛ 👇

<code>/set_shortner ez4short.com 837b7a64653f5237840f1251d0c1ce</code>

<code>/set_shortner_2 omnifly.in.net f287e7e77787d39607cae36a4d</code>

<code>/set_shortner_3 shortslink.in 06b24eb62fb3f696b6d5de11354</code>
...
📌 <u>ʏᴏᴜ ᴀʀᴇ ɴᴏᴛ ᴠᴇʀɪғɪᴇᴅ ᴛᴏᴅᴀʏ😌, Its Very Simple Just ᴄʟɪᴄᴋ ᴏɴ ♻ᴠᴇʀɪғʏ♻ & ɢᴇᴛ ᴜɴʟɪᴍɪᴛᴇᴅ ᴀᴄᴄᴇꜱꜱ ғᴏʀ ᴛɪʟʟ ɴᴇxᴛ ᴠᴇʀɪғɪᴄᴀᴛɪᴏɴ😎</u>
